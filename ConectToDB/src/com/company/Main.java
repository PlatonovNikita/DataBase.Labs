...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            create(st); //Создаём столбец в бд. Используется один раз далее закоментируется

            insert(st); //Аналогично

            ResultSet rs = st.executeQuery("SELECT * from visitors WHERE position = 'Student' AND city = 'Nizhniy Novgorod'");
    ...
    public static void create(Statement st){
        try {
